...
(canvas as unknown as HTMLCanvasElement).width / (canvas as unknown as HTMLCanvasElement).height
      );
    ...
    function correctRadius(radius: any) {
      const aspectRatio = (canvas as unknown as HTMLCanvasElement).width / (canvas as unknown as HTMLCanvasElement).height;
    ...
    function updatePointerDownData(pointer: any, id: any, posX: any, posY: any) {
      ...
      pointer.down = true;
      pointer.moved = false;
      pointer.texcoordX = posX / (canvas as unknown as HTMLCanvasElement).width;
      pointer.texcoordY = 1.0 - posY / (canvas as unknown as HTMLCanvasElement).height;
